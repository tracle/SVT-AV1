...
#define CLASS_12_NEW_TOKEN "-class-12"
...
ConfigEntry config_entry_specific[] = {
    ...
    {SINGLE_INPUT, RDOQ_NEW_TOKEN, "Enable RDOQ (0: OFF, 1: ON, -1: DEFAULT)", set_enable_rdoq_flag},
    ...
    {SINGLE_INPUT, REDUNDANT_BLK_NEW_TOKEN, "RedundantBlock", set_enable_redundant_blk_flag},
    {SINGLE_INPUT, SPATIAL_SSE_FL_NEW_TOKEN, "SpatialSSEfl", set_spatial_sse_fl_flag},
    {SINGLE_INPUT, OVR_BNDRY_BLK_NEW_TOKEN, "OverBoundryBlock", set_over_bndry_blk_flag},
    {SINGLE_INPUT,
     NEW_NEAREST_COMB_INJECT_NEW_TOKEN,
    ...
    {SINGLE_INPUT,
     ...
     set_nx4_4xn_parent_mv_inject_flag},
    {SINGLE_INPUT, PRUNE_UNIPRED_ME_NEW_TOKEN, "PruneUnipredMe", set_prune_unipred_me_flag},
    {SINGLE_INPUT, PRUNE_REF_REC_PART_NEW_TOKEN, "PruneRefRecPart", set_prune_ref_rec_part_flag},
    {SINGLE_INPUT, NSQ_TABLE_NEW_TOKEN, "NsqTable", set_nsq_table_flag},
    {SINGLE_INPUT,
     FRAME_END_CDF_UPDATE_NEW_TOKEN,
     "FrameEndCdfUpdate",
     set_frame_end_cdf_update_flag},
    {SINGLE_INPUT,
     ...
     "LocalWarpedMotion",
     set_enable_local_warped_motion_flag},
    {SINGLE_INPUT, GLOBAL_MOTION_ENABLE_NEW_TOKEN, "GlobalMotion", set_enable_global_motion_flag},
    {SINGLE_INPUT, RDOQ_NEW_TOKEN, "RDOQ", set_enable_rdoq_flag},
    {SINGLE_INPUT, FILTER_INTRA_NEW_TOKEN, "FilterIntra", set_enable_filter_intra_flag},
    ...
    while (config_entry[++token_index].name != NULL) {
        if (config_entry[token_index].type == SINGLE_INPUT) {
            ...
            if (find_token_multiple_inputs(
                ...
                //Warning for one dahs
                if (*(config_entry[token_index].token + 2) != '\0' &&
                    *(config_entry[token_index].token + 1) != '-' &&
