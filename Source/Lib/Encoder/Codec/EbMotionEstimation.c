...
#if ALIGN_HME_L2_SR_WITH_HEM_L0 || HME_L2_DISTANCE_ALGORITHM
                 int16_t hme_level2_search_area_in_width,
                 int16_t hme_level2_search_area_in_height,
#endif
 #if HME_L2_DISTANCE_ALGORITHM
                 uint32_t hme_sr_factor_x,
                 uint32_t hme_sr_factor_y,
#endif
                 // number in the vertical direction
...
#else
#if HME_L2_DISTANCE_ALGORITHM || ALIGN_HME_L2_SR_WITH_HEM_L0
#if HME_L2_DISTANCE_ALGORITHM
...
#endif
#if TWO_LEVEL_HME || ONE_LEVEL_HME
...
#if ALIGN_HME_L1_SR_WITH_HEM_L0
                                hmeLevel1SearchAreaInWidth = (int16_t)context_ptr->hme_level0_search_area_in_width_array[search_region_number_in_width] * 2;
                                hmeLevel1SearchAreaInHeight = (int16_t)context_ptr->hme_level0_search_area_in_height_array[search_region_number_in_height] * 2;
#endif
                                hme_level_1(
                                    context_ptr,
                                    origin_x >> 1,
            ...
            if (pcs_ptr->temporal_layer_index > 0 || list_index == 0) {
                ...
                if (context_ptr->enable_hme_flag && /*B*/ sb_height == BLOCK_SIZE_64) {
                    ...
                    if (enable_hme_level2_flag) {
                        ...
                        while (search_region_number_in_height < context_ptr->number_hme_search_region_in_height) {
                            while (search_region_number_in_width < context_ptr->number_hme_search_region_in_width) {
#if ALIGN_HME_L2_SR_WITH_HEM_L0
                                int16_t hmeLevel2_search_area_in_width = (int16_t)context_ptr->hme_level0_search_area_in_width_array[search_region_number_in_width] * 4;
                                int16_t hmeLevel2_search_area_in_height = (int16_t)context_ptr->hme_level0_search_area_in_height_array[search_region_number_in_height] * 4;
#else
                                int16_t hmeLevel2_search_area_in_width = (int16_t)context_ptr->hme_level2_search_area_in_width_array[search_region_number_in_width];
                                int16_t hmeLevel2_search_area_in_height = (int16_t)context_ptr->hme_level2_search_area_in_height_array[search_region_number_in_height];
#endif
                                hme_level_2(
                                    pcs_ptr,
                                    context_ptr,
