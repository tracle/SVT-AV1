...
#define NIC_C4 6
    ...
    if (context_ptr->combine_class12)
        context_ptr->md_stage_1_count[CAND_CLASS_3] = context_ptr->md_stage_2_count[CAND_CLASS_3] =
            0;
#if UNIFIED_NICS
    context_ptr->md_stage_1_count[CAND_CLASS_0] = 4;
    context_ptr->md_stage_1_count[CAND_CLASS_1] = 4;
    context_ptr->md_stage_1_count[CAND_CLASS_2] = 4;
    context_ptr->md_stage_1_count[CAND_CLASS_3] = 4;
    context_ptr->md_stage_1_count[CAND_CLASS_4] = 4;
    context_ptr->md_stage_1_count[CAND_CLASS_5] = 4;
    context_ptr->md_stage_1_count[CAND_CLASS_6] = 4;
